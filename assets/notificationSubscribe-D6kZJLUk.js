import{a as m}from"./interceptor-D0k6Tg0i.js";import{c as d}from"./config-E-HGwCPq.js";import{T as y}from"./index-C0eOhpfv.js";const r={notificationBell:document.querySelector(".notif-bell"),notificationList:document.querySelector("#notif-list"),notificationCount:document.querySelector("#notif-count"),offcanvasEl:document.querySelector("#notificationOffcanvas"),canvasClose:document.querySelector(".offcanvas-header .btn-close"),loaderContainer:document.querySelector("#loaderContainer"),sentinel:document.querySelector("#sentinel")},b=e=>{const t=e.seen?"":"bg-light",a=e.isCancelled?"bg-danger-subtle":"",i=new Date(e.createdAt).toLocaleString();let s="",n="";return e.type==="pendingShipment"&&(!e.isShipped&&!e.isCancelled&&(s=`
